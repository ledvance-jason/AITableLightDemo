...
object LogManager {
    ...
    private const val PUB_KEY =
        "4f6be58d1c00a4bd8d0057f8a5ebceacb25d1fac913fa7c3999951964c1f70f3c79309c558c683bf773168730aa8456c2a4f8128a3d2c6e7292921679449bb3d"
    private var mLogcatInstance: Log.LogInstance? = null

    internal fun initialize(context: Context, enableLogcat: Boolean = true) {
